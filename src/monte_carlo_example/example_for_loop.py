...
def monte_carlo_example_for_loop(
    ...
    """
    Run a Monte Carlo simulation to estimate `pi` using a for-loop implementation
    and optionally save the results as an interactive HTML plot.

    This function wraps the for-loop-based estimation logic, generates a DataFrame
    ...
    Example:
        ...
        monte_carlo_example_for_loop(
            square_polygon=SQUARE,
            inscribed_circle_polygon=INSCRIBED_CIRCLE,
            n_samples=1000,
            seed=42,
            file="C:\\Users\\Archimedes\\Downloads\\monte_carlo_for_loop.html",
    ...
    estimate_df = generate_estimates_for_loop(
...
if __name__ == "__main__":
    ...
    monte_carlo_example_for_loop(
        ...
        n_samples=10000,
        seed=42,
        file=r"src\monte_carlo_example\figs\monte_carlo_example_for_loop.html",
        x_label="observations",
        y_label="pi_estimate",
    )
